...
ROOT_URLCONF = 'ski_conditions.urls'
...
WSGI_APPLICATION = 'ski_conditions.wsgi.application'
...
CACHES = {
    'default': env.cache(default='locmemcache://ski_conditions'),
}
...
DEFAULT_FILE_STORAGE = env('DEFAULT_FILE_STORAGE', cast=str,
                           default='ski_conditions.apps.core.backends.MediaStorage')
