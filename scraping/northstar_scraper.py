def ski_scraper(url):
    ...
    acres_open = int(trails_summary_items[2].get_text())
    terrain_percent = int(trails_summary_items[3].get_text())
    trails_open = int(trails_summary_items[1].get_text())
    lifts_open = int(trails_summary_items[0].get_text())
...
resort_name = 'Northstar'
total_trails, total_lifts, acres_open, terrain_percent, trails_open, lifts_open = \
        ski_scraper(url)

print('total trails', total_trails)
print('total lifts', total_lifts)

print('acres', acres_open)
print('terrain', terrain_percent)
print('trails', trails_open)
print('lifts', lifts_open)
